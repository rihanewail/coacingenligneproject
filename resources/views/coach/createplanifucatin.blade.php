...
<div>
    ...
    <form action="{{ route('DemandePlanification.store') }}" method="POST">
        @csrf
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea  class="form-control" placeholder="Nom" id="description" name="description"></textarea>
        </div>
        <div class="form-group">
            <label for="dateDebut">Start Date:</label>
            <input type="date"  class="form-control" placeholder="Nom" id="dateDebut" name="dateDebut">
        </div>
        <div class="form-group">
            <label for="dateFin">End Dates:</label>
            <input type="date"  class="form-control" placeholder="Nom" id="dateFin" name="dateFin">
        </div>
        <div class="form-group">
            <label for="prix">Price:</label>
            <input type="number" step="0.01"  class="form-control" placeholder="Nom"id="prix" name="prix">
        </div>
