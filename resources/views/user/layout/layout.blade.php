    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('dashboard') }} /assets/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ asset('dashboard') }} /assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      <div class="col-4 col-sm-3 col-xl-2">
                        <img src="{{ asset('dashboard') }} /assets/images/dashboard/Group126@2x.png" class="gradient-corona-img img-fluid" alt="">
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        <i cl{{ asset('dashboard') }} /ass="icon-lg mdi mdi-codepen text-primary ml-auto"></i>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{ asset('dashboard') }} /assets/images/faces/face5.jpg" alt="image" />
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="preview-list">
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{ asset('dashboard') }} /assets/images/faces/face6.jpg" alt="image" class="rounded-circle" />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{ asset('dashboard') }} /assets/images/faces/face8.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{ asset('dashboard') }} /assets/images/faces/face9.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{ asset('dashboard') }} /assets/images/faces/face11.jpg" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
                      <div class="item">
                        <img src="{{ asset('dashboard') }} /assets/images/dashboard/Rectangle.jpg" alt="">
                      </div>
                      <div class="item">
                        <img src="{{ asset('dashboard') }} /assets/images/dashboard/Img_5.jpg" alt="">
                      </div>
                      <div class="item">
                        <img src="{{ asset('dashboard') }} /assets/images/dashboard/img_6.jpg" alt="">
                      </div>
                    </div>
                    <div class="d-flex py-4">
                      <div class="preview-list w-100">
                        <div class="preview-item p-0">
                          <div class="preview-thumbnail">
                            <img src="{{ asset('dashboard') }} /assets/images/faces/face12.jpg" class="rounded-circle" alt="">
                          </div>
                          <div class="preview-item-content d-flex flex-grow">
                            <div class="flex-grow">
                              <div class="d-flex d-md-block d-xl-flex justify-content-between">
